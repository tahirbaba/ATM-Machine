...
if (myPin === pinAns.pin) {
    ...
    if (operation.options === "check balance") {
        ...
        console.log(`your remaining balance is Rs.${myBalance - amountFastCash.fastcash}`);
    }
        ...
        console.log(`your deposited ${amountDeposit.deposit} amount of Rs.${myBalance}`);
        console.log(`Now your total Amount is ${myBalance + amountDeposit.deposit}`);
    }
        ...
        if (amountWithdraw.withdraw <= myBalance) {
            ...
            console.log(`your remaining balance is ${myBalance - amountWithdraw.withdraw} Rs.`);
        }
        else {
